...
def create_tray_icon():
    ...
    # Рисуем простой таймер (круг с цифрами)
    draw.ellipse([2, 2, 14, 14], outline=(0, 255, 65), width=1)
    draw.line([8, 8, 8, 4], fill=(0, 255, 65), width=1)  # часовая стрелка
    draw.line([8, 8, 12, 8], fill=(0, 255, 65), width=1)  # минутная стрелка
